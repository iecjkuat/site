// JKUAT Innovation Club - Opportunities Page Navigation Component

class OpportunitiesNavigation {
    constructor() {
        this.init();
    }

    init() {
        console.log('🧭 OpportunitiesNavigation init() called');
        this.renderNavigation();
        this.bindEvents();
        console.log('✅ OpportunitiesNavigation init() completed');
    }
                ...
                <div class="container">
                    ...
                    <div class="nav-links-container">
                        ...
                        <div class="nav-center">
                            ...
                            <a href="/opportunities" class="glass-button active">
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('🧭 Opportunities Navigation DOM loaded');
    
    // Try immediate initialization
    const navigationPlaceholder = document.getElementById('navigation-placeholder');
    if (navigationPlaceholder) {
        console.log('✅ Found navigation placeholder immediately');
        window.opportunitiesNavigation = new OpportunitiesNavigation();
    } else {
...
window.OpportunitiesNavigation = OpportunitiesNavigation;