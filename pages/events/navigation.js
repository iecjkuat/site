// Events Page - Navigation Component
...
class EventsNavigation {
    ...
    init() {
        console.log('🧭 Initializing EventsNavigation...');
        this.createNavigation();
        this.bindEvents();
        console.log('✅ EventsNavigation initialized');
    }
                ...
                <div class="container">
                    ...
                    <div class="nav-links-container">
                        ...
                        <div class="nav-center">
                            ...
                            <a href="/events" class="glass-button" style="background: rgba(16, 185, 129, 0.2) !important; border-color: rgba(16, 185, 129, 0.3) !important; color: #10b981 !important;">
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('🧭 Events Navigation DOM loaded');
    setTimeout(() => {
        window.eventsNavigation = new EventsNavigation();
    }, 100);
});

// Make available globally
window.EventsNavigation = EventsNavigation;