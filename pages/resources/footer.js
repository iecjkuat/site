// JKUAT Innovation Club - Resources Page Footer Component

class ResourcesFooter {
    constructor() {
        this.init();
    }

    init() {
        console.log('🦶 Resources Footer init() called');
        this.renderFooter();
        console.log('✅ Resources Footer init() completed');
    }
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('🦶 Resources Footer DOM loaded');
    window.resourcesFooter = new ResourcesFooter();
});

// Make available globally
window.ResourcesFooter = ResourcesFooter;